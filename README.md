...
현재 구현은 Phase 0/1 계산기, Phase 2 관리형 MVP, Phase 3 실제 데이터 연동 MVP, Phase 4 개인용 거래 보조 MVP를 포함합니다. 앱 데이터는 브라우저 로컬 저장소에 저장되며, Prisma 스키마는 서버 저장 전환을 위한 기준 모델로 유지합니다.
